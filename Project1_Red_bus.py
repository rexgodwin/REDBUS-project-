...
# kerala bus
lists_k=[]
df_k=pd.read_csv(r'C:/Users/rexgo/OneDrive/Desktop/redbuss/csv/df_k.csv') #C:\Users\rexgo\OneDrive\Desktop\redbuss\csv
for i,r in df_k.iterrows():
    lists_k.append(r["Route_name"])

#Andhra bus
lists_A=[]
df_A=pd.read_csv(r'C:/Users/rexgo/OneDrive/Desktop/redbuss/csv/df_A.csv')
for i,r in df_A.iterrows():
    lists_A.append(r["Route_name"])

#Telungana bus
lists_T=[]
df_T=pd.read_csv(r'C:/Users/rexgo/OneDrive/Desktop/redbuss/csv/df_T.csv')
for i,r in df_T.iterrows():
    lists_T.append(r["Route_name"])

#Goa bus
lists_g=[]
df_G=pd.read_csv(r'C:/Users/rexgo/OneDrive/Desktop/redbuss/csv/df_G.csv')
for i,r in df_G.iterrows():
    lists_g.append(r["Route_name"])

#Rajastan bus
lists_R=[]
df_R=pd.read_csv(r'C:/Users/rexgo/OneDrive/Desktop/redbuss/csv/df_R.csv')
...
# South bengal bus 
lists_SB=[]
df_SB=pd.read_csv(r'C:/Users/rexgo/OneDrive/Desktop/redbuss/csv/df_SB.csv')
for i,r in df_SB.iterrows():
    lists_SB.append(r["Route_name"])

# Haryana bus
lists_H=[]
df_H=pd.read_csv(r'C:/Users/rexgo/OneDrive/Desktop/redbuss/csv/df_H.csv')
for i,r in df_H.iterrows():
    lists_H.append(r["Route_name"])

#Assam bus
lists_AS=[]
df_AS=pd.read_csv(r'C:/Users/rexgo/OneDrive/Desktop/redbuss/csv/df_AS.csv')
for i,r in df_AS.iterrows():
    lists_AS.append(r["Route_name"])

#UP bus
lists_UP=[]
df_UP=pd.read_csv(r'C:/Users/rexgo/OneDrive/Desktop/redbuss/csv/df_UP.csv')
for i,r in df_UP.iterrows():
    lists_UP.append(r["Route_name"])

#West bengal bus
lists_WB=[]
df_WB=pd.read_csv(r'C:/Users/rexgo/OneDrive/Desktop/redbuss/csv/df_WB.csv')
...
web=option_menu(menu_title="Online Bus Booking",
...
if web=="Home":
    ...
    slt.subheader(":blue[Developed-by:] Rex")
    slt.subheader(":blue[USED:] ")
    slt.markdown("Selenium, Python, Pandas, MySQL,mysql-connector-python, Workbench, Streamlit.")
...
if web == "📍States and Routes":
    ...
    if S == "Kerala":
        ...
        def type_and_fare(bus_type, fare_range):
            conn = mysql.connector.connect(host="localhost", user="root", password="root123", database="RED_BUS_DETAILS")
